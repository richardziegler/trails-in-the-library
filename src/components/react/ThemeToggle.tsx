		...
		<>
			<div className="relative inline-block w-14 h-6">
				<input checked={isChecked} onChange={() => {
					$currentTheme.set(themeOptions.filter((theme) => theme !== currentTheme)[0])
				...
				<label htmlFor="switch-component" className="absolute top-0 left-0 w-5 h-5 bg-white rounded-full border border-slate-300 shadow-sm transition-transform duration-300 peer-checked:translate-x-6 peer-checked:border-slate-800 cursor-pointer">
					{isChecked ? (
						// moon
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="1 0 32 30" fill="currentColor" className="size-6 text-slate-800">
							<path fill-rule="evenodd" d="M9.528 1.718a.75.75 0 0 1 .162.819A8.97 8.97 0 0 0 9 6a9 9 0 0 0 9 9 8.97 8.97 0 0 0 3.463-.69.75.75 0 0 1 .981.98 10.503 10.503 0 0 1-9.694 6.46c-5.799 0-10.5-4.7-10.5-10.5 0-4.368 2.667-8.112 6.46-9.694a.75.75 0 0 1 .818.162Z" clip-rule="evenodd" />
						</svg>
					) : (
						// sun
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 1 32 30" fill="text-slate-800" className="size-6 text-slate-800">
